...
## Tres puntos destacados del proyecto
1. **Contenido turístico y divulgativo**  
   La web presenta información clara y accesible sobre las principales zonas del parque, rutas, fauna, paisajes y experiencias recomendadas para el visitante.

2. **Integración de recursos multimedia**  
   Se incluyen vídeos, audios, subtítulos, imágenes y secciones interactivas para mejorar la experiencia del usuario y ofrecer una visión más inmersiva del entorno natural.

3. **Diseño responsive con HTML5 y Bootstrap**  
   La estructura está optimizada para dispositivos móviles, tablets y ordenadores, utilizando componentes modernos, animaciones y un diseño limpio.
...
- Uso de herramientas de compresión, formateo (a WebP) y redimensionamiento de imagenes

Todos los recursos externos respetan sus licencias originales y se emplean únicamente con fines educativos.

## Explicación breve de los atributos HTML5 utilizados
...
- `<textarea>` se utiliza para mensajes más largos.  
- `<label>` vinculado mediante `for` mejora la accesibilidad.

### Imágenes
- `<img>` con atributo `alt` describe la imagen para lectores de pantalla y mejora el SEO.
